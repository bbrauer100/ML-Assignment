...
An overall pseudo-random number generator seed was set at 5678 for all code. In order to reproduce the results below, the same seed should be used.
...
trainingset <- read.csv("C:/Users/BeBrauer/Documents/pml-training.csv", na.strings=c("NA","#DIV/0!", ""))

# Loading the testing data set 
testingset <- read.csv("C:/Users/BeBrauer/Documents/pml-testing.csv", na.strings=c("NA","#DIV/0!", ""))
